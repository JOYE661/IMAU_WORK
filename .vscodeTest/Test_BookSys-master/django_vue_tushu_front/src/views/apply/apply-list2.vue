<template>
    ...
    <el-card shadow="never" style="margin-top: 10px;">
      ...
      <!-- 新增或编辑的抽屉 -->
  <sDrawer v-model="visible" :title="form.id ? '申请' : '申请'" size="35%" :close-on-click-modal="false">
    <el-form :model="form" label-width="50px" ref="ruleFormRef">
      ...
      <el-form-item label="申请人:" label-width="80px">
        <el-input v-model="form.sqren" />
      </el-form-item>
      <el-form-item label="申请理由:" label-width="80px">
        <el-input v-model="form.sqliyou" />
      </el-form-item>
      <!-- <el-form-item label="账号:">
        <el-input v-model="form.shzhuangtai" />
      </el-form-item>
      <el-form-item label="密码:">
        <el-input v-model="form.cttime" />
      </el-form-item>
      <el-form-item label="密码:">
        <el-input v-model="form.mdtime" />
      </el-form-item> -->
    </el-form>
    <template #footer>
...
export default {
    ...
    methods: {
        ...
        async saveData() {
            ...
            const res = await this.$request.post('/jc/shenpi/', this.form)
            if (res.data.code === 200) 
            {
