...
export default {
  ...
  methods: {
    ...
    async saveData() {
      if (this.form.id) {
        const res = await this.$request.put('/django_vue_tushu/zz/' + this.form.id + '/', this.form)
        if (res.data.code === 200) {
        ...
        const res = await this.$request.post('/django_vue_tushu/zz/', this.form)
        if (res.data.code === 200) {
        this.$message.success(res.data.message)
        this.getList()
        this.visible = false
    ...
    async deleteItem(id) {
      const res = await this.$request.delete("/django_vue_tushu/zz/" + id + '/')
      if (res.data.code === 200) {
        this.$message.success(res.data.message)
        this.getList()
      }
