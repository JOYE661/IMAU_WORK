...
public class ActiveMQSession implements Session, QueueSession, TopicSession, StatsCapable, ActiveMQDispatcher {
    ...
    public ActiveMQFileMessage createFileMessage() throws JMSException{
        ActiveMQFileMessage message = new ActiveMQFileMessage();
        configureMessage(message);
        return message;
    }

    public ActiveMQFileMessage createFileMessage(File file) throws JMSException{
        ActiveMQFileMessage message = new ActiveMQFileMessage();
